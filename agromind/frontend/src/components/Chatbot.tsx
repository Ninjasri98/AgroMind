...
export const Chatbot: React.FC = () => {
  ...
  return (
    <div className="relative mt-3 ml-3 mr-3 mb-3">
      ...
      <div className="border-2 border-black flex flex-col h-150 bg-white relative z-10 w-full">
        {/* Header */}
          ...
          {messages.map((msg, i) => (
            <div key={i} className={cn("flex w-full", msg.role === 'user' ? "justify-end" : "justify-start")}>
              <div className={cn("flex max-w-[85%]", msg.role === 'user' ? "flex-row-reverse" : "flex-row")}>
                <div className={cn(
                  "w-11 h-11 border-2 border-black flex items-center justify-center shrink-0", 
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="flex max-w-[85%] flex-row">
                <div className="w-11 h-11 border-2 border-black flex items-center justify-center shrink-0 mr-4 bg-black text-white">
        ...
        <div className="p-6 bg-white border-t-2 border-black shrink-0 relative">
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSend(input); }} className="flex space-x-4">
            ...
            <button
              ...
              className="w-14 h-14 border-2 border-black flex items-center justify-center bg-white hover:bg-black hover:text-white transition-colors disabled:opacity-50 disabled:hover:bg-white disabled:hover:text-black shrink-0"
            >
