    ...
    <div className="flex flex-col bg-white">
        ...
        {RANGES.map((range, index) => (
          <div key={range.key} className="border-b-2 border-black p-4 transition-colors group hover:bg-black hover:text-white flex flex-col space-y-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-7 h-7 bg-black text-white font-serif flex items-center justify-center shrink-0 group-hover:bg-white group-hover:text-black">
      ...
      <div className="p-4 bg-gray-50 border-b-2 border-black">
        <button
          ...
          disabled={isLoading}
          className="w-full border-2 border-black bg-white text-black font-sans uppercase tracking-widest text-sm py-4 hover:bg-black hover:text-white transition-colors flex items-center justify-center disabled:opacity-50 disabled:hover:bg-white disabled:hover:text-black"
        >
          {isLoading ? (
